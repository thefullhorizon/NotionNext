...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1622186ad85d815fa067e91d89a53e80', //temporally downline the english site
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Taylor', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || '基于大数据+AI，通过数字化、智能化，帮助个人和中小企业实现持续的商业价值。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://taylorai.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'thefullhorizon@gmail.com', // 邮箱地址 例如mail@tangly1024.com
